...
<div class="transaction-index">
    ...
    <?= GridView::widget([
    	...
    	'options' => array('style' => 'margin:40px 0px 0px;'),
        'columns' => [
    ...
    <p>
        <?php //= Html::a('Download Account Statement', ['../account-statement/view','id'=>$accountStatementId], ['class' => 'btn btn-success']) ?>
    	<?= Html::a('Account Statements', ['../account-statement/index'], ['class' => 'btn btn-primary']) ?>
    </p>
</div>
